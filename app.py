...
def do_login(code):
    url = 'https://api.weixin.qq.com/sns/jscode2session?appid=wxb8661913813de86b&secret=5e04270b954d99aedadbb7c35550880d&js_code={}&grant_type=authorization_code'.format(code)
...
def get_token(data):
    ...
    open_id = data['openid']
    sk = data['session_key']
    source = '{}_{}_{}'.format(sk, open_id, ts)
...
def top250():
    rv = [{
        ...
        "title": "霸王别姬  / 再见，我的妾 / Farewell My Concubine ",
        "desc": "段小楼（张丰毅）与程蝶衣（张国荣）是一对打小一起长大的师兄弟，两人一个演生，一个饰旦，一向配合天衣无缝，尤其一出《霸王别姬》，更是誉满京城，为此，两人约定合演一辈子《霸王别姬》。但两人对戏剧与人生关系的理解有本质不同，段小楼深知戏非人生，程蝶衣则是人戏不分。段小楼在认为该成家立业之时迎娶了名妓菊仙（巩俐），致使程蝶衣认定菊仙是可耻的第三者，使段小楼做了叛徒，自此，三人围绕一出《霸王别姬》生出的爱恨情仇战开始随着时代风云的变迁不断升级，终酿成悲剧。",
        "score": 9.6,
        "rank": 2
    },{
        "img": "https://img2.doubanio.com/view/photo/s_ratio_poster/public/p2372307693.webp",
        "title": "阿甘正传  / Forrest Gump  / 福雷斯特·冈普",
        ...
        "title": "这个杀手不太冷  / Léon  / 杀手莱昂 / 终极追杀令(台)",
        "desc": """里昂（让·雷诺饰）是名孤独的职业杀手，受人雇佣。一天，邻居家小姑娘马蒂尔达（纳塔丽·波特曼饰)敲开他的房门，要求在他那里暂避杀身之祸。原来邻居家的主人是警方缉毒组的眼线，只因贪污了一小包毒品而遭恶警（加里·奥德曼饰）杀害全家的惩罚。马蒂尔达得到里昂的留救，幸免于难，并留在里昂那里。里昂教小女孩使枪，她教里昂法文，两人关系日趋亲密，相处融洽。
...
　　1912年4月14日，星期天晚上，一个风平浪静的夜晚。泰坦尼克号撞上了冰山，“永不沉没的”泰坦尼克号面临沉船的命运，罗丝和杰克刚萌芽的爱情也将经历生死的考验。""",
        ...
        "img": "https://img2.doubanio.com/view/photo/s_ratio_poster/public/p2578474613.webp",
        "title": "美丽人生  / La vita è bella  / 一个快乐的传说(港) / Life Is Beautiful",
        "desc": """犹太青年圭多（罗伯托·贝尼尼）邂逅美丽的女教师多拉（尼可莱塔·布拉斯基），他彬彬有礼的向多拉鞠躬：“早安！公主！”。历经诸多令人啼笑皆非的周折后，天遂人愿，两人幸福美满的生活在一起。
...
　　法西斯政权即将倾覆，纳粹的集中营很快就要接受最后的清理，圭多编给儿子的游戏该怎么结束？他们一家能否平安的度过这黑暗的年代呢？""",
        ...
        "title": "千与千寻  / 千と千尋の神隠し  / 神隐少女(台) / 千与千寻的神隐",
        "desc": """千寻和爸爸妈妈一同驱车前往新家，在郊外的小路上不慎进入了神秘的隧道——他们去到了另外一个诡异世界—一个中世纪的小镇。远处飘来食物的香味，爸爸妈妈大快朵颐，孰料之后变成了猪！这时小镇上渐渐来了许多样子古怪、半透明的人。
...
　　为了救小白，千寻又踏上了她的冒险之旅。""",
        ...
        "img": "https://img2.doubanio.com/view/photo/s_ratio_poster/public/p492406163.webp",
        "title": "辛德勒的名单  / Schindler's List  / 舒特拉的名单(港) / 辛德勒名单",   
        "desc": """1939年，波兰在纳粹德国的统治下，党卫军对犹太人进行了隔离统治。德国商人奥斯卡·辛德勒（连姆·尼森 Liam Neeson 饰）来到德军统治下的克拉科夫，开设了一间搪瓷厂，生产军需用品。凭着出众的社交能力和大量的金钱，辛德勒和德军建立了良好的关系，他的工厂雇用犹太人工作，大发战争财。
...
　　1944年，德国战败前夕，屠杀犹太人的行动越发疯狂，辛德勒向德军军官开出了1200人的名单，倾家荡产买下了这些犹太人的生命。在那些暗无天日的岁月里，拯救一个人，就是拯救全世界。""",
        ...
        "img": "https://img2.doubanio.com/view/photo/s_ratio_poster/public/p2616355133.webp",
        "title": "盗梦空间  / Inception  / 潜行凶间(港) / 全面启动(台)",
        ...
        "img": "https://img3.doubanio.com/view/photo/s_ratio_poster/public/p2587099240.webp",
        "title": "忠犬八公的故事  / Hachi: A Dog's Tale  / 秋田犬八千(港) / 忠犬小八(台) ",
        "desc": """八公（Forest 饰）是一条谜一样的犬，因为没有人知道它从哪里来。教授帕克（理查·基尔 Richard Gere 饰）在小镇的火车站拣到一只走失的小狗，冥冥中似乎注定小狗和帕克教授有着某种缘分，帕克一抱起这只小狗就再也放不下来，最终，帕克对小狗八公的疼爱感化了起初极力反对养狗的妻子卡特（琼·艾伦 Joan Allen 饰）。八公在帕克的呵护下慢慢长大，帕克上班时八公会一直把他送到车站，下班时八公也会早早便爬在车站等候，八公的忠诚让小镇的人家对它更加疼爱。有一天，八公在帕克要上班时表现异常，居然玩起了以往从来不会的捡球游戏，八公的表现让帕克非常满意，可是就是在那天，帕克因病去世。帕克的妻子、女儿安迪（萨拉·罗默尔 Sarah Roemer 饰）及女婿迈克尔（罗比·萨布莱特 Robbie Sublett 饰）怀着无比沉痛的心情埋葬了帕克，可是不明就里的...""",
        "score": 9.4,
        "rank": 10
    }]
...
def login():
    ...
    rds.setex(token, 3600 * 5, json.dumps(data, ensure_ascii=False))
    return token
